...
interface ICashOutRetention {
  ...
  function Delete(address recordId) external returns(bool);
  function Exists(address recordId) external returns(bool);
  function GetById(address recordId) external returns(uint256,ICashOutRetention.Data memory,ICashOutRetention.Data memory);
  function GetByIndex(uint256 recordIndex) external returns(address,ICashOutRetention.Data memory,ICashOutRetention.Data memory);
  function GetLength() external returns(uint256);
  function GetPermission(uint256 index) external returns(address);
  function GetPermissionListLength() external returns(uint256);
  function HasPermission(address sender) external returns(bool);
...
contract trigger is owned {
  ...
  function invoke(address _recordId) public  returns(bool){
    ...
    //Invoke Required Condition Functions
      ...
      Condition2(CashoutII_GetById_record.A_Payee);
  ...
  function Condition1(address CBA_Payee) private  {
        ...
        for(uint x = 0; x < CashOutRetention.GetLength(); x++){

          address CashOutRetention_GetByIndex_recordId;
          ICashOutRetention.Data memory CashOutRetention_GetByIndex_record;
          ICashOutRetention.Data memory CashOutRetention_GetByIndex_R_CashoutII_Data;
          (CashOutRetention_GetByIndex_recordId,CashOutRetention_GetByIndex_record,CashOutRetention_GetByIndex_R_CashoutII_Data) = CashOutRetention.GetByIndex(x);

            if(CBA_Payee == CashOutRetention_GetByIndex_record.A_RetentionRecipient){
              contains = true;
  ...
  function Condition2(address CBA_Payee) private  {
