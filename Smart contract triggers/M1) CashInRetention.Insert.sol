...
contract trigger is owned {
  ...
  function invoke(ICashOutRetention.Data memory CashOutRetention_Data) public  returns(bool){
    ...
    CashOutRetention_Data.A_Created = block.timestamp * 1000;
    CashOutRetention_Data.A_Retention = 1000000000000000;
    CashOutRetention_Data.A_Percent = 5;
    CashOutRetention_Data.A_DLPmonths = 12;
    CashOutRetention_Data.A_Status = 'Registered';
    CashOutRetention_Data.A_ReleaseDate = block.timestamp * 1000;
    CashOutRetention_Data.A_PayCode = 'TEST-300';
    CashOutRetention_Data.A_LastUpdate = block.timestamp * 1000;
    CashOutRetention_Data.A_RetentionRecipient = payable(msg.sender);
    CashOutRetention_Data.A_CashoutII_Pointer = FindRecordId(msg.sender);

    //Execute Action
    require(CashOutRetention.Insert(CashOutRetention_Data));
