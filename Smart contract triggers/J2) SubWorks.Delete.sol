...
contract trigger is owned {
  ...
  function invoke(address _recordId) public  returns(bool){
    ...
    uint256 SubcWorksII_GetById_index;
    ISubcWorksII.Data memory SubcWorksII_GetById_record;
    ICashoutII.Data memory SubcWorksII_GetById_R_CashoutII_Data;
    (SubcWorksII_GetById_index,SubcWorksII_GetById_record,SubcWorksII_GetById_R_CashoutII_Data) = SubcWorksII.GetById(_recordId);
    ...
    //Execute Action
    require(SubcWorksII.Delete(_recordId));
