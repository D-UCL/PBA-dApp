...
contract trigger is owned {
  ...
  function invoke(address _recordId,ICashOutRetention.Data memory CashOutRetention_Data) public payable returns(bool){
    ...
    require(msg.value == CashOutRetention_GetById_record.A_Retention);
          payable(CashOutRetention_GetById_record.A_RetentionRecipient).transfer(msg.value);

    //Invoke Required Condition Functions
      Condition0(msg.sender);

    //Map Values to Action Interface
    CashOutRetention_Data.A_Created = CashOutRetention_GetById_record.A_Created;
    CashOutRetention_Data.A_Retention = CashOutRetention_GetById_record.A_Retention;
    CashOutRetention_Data.A_Percent = CashOutRetention_GetById_record.A_Percent;
    CashOutRetention_Data.A_DLPmonths = CashOutRetention_GetById_record.A_DLPmonths;
    CashOutRetention_Data.A_Status = 'Paid';
    CashOutRetention_Data.A_ReleaseDate = CashOutRetention_GetById_record.A_ReleaseDate;
    CashOutRetention_Data.A_PayCode = CashOutRetention_GetById_record.A_PayCode;
    CashOutRetention_Data.A_LastUpdate = CashOutRetention_GetById_record.A_LastUpdate;
    CashOutRetention_Data.A_RetentionRecipient = CashOutRetention_GetById_record.A_RetentionRecipient;
    CashOutRetention_Data.A_CashoutII_Pointer = CashOutRetention_GetById_record.A_CashoutII_Pointer;

    //Execute Action
    require(CashOutRetention.Update(_recordId,CashOutRetention_Data));
