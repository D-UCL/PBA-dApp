//Description: Allows the client to execute the cash-in retention payment by updating SC table L4.
//SC conditions: User’s address is in SC table A: Client.
//Etherscan address: https://goerli.etherscan.io/address/0xccC6Ba989be52A6fbfBF0fF04e786eD17c59F223

pragma solidity ^0.8.4;
pragma experimental ABIEncoderV2;

//Name: CashinRetention_Paid
...
contract trigger is owned {
  ...
  function invoke(address _recordId,ICashInRetention.Data memory CashInRetention_Data) public payable returns(bool){
    ...
    require(msg.value == CashInRetention_GetById_record.A_Retention);
          payable(CashInRetention_GetById_record.A_RetentionRecipient).transfer(msg.value);
    ...
    CashInRetention_Data.A_Status = 'Paid';
