...
contract trigger is owned {
  ...
  function invoke(address _recordId,IPaymentGuaranteeI.Data memory PaymentGuaranteeI_Data) public payable returns(bool){
    ...
    require(msg.value == PaymentGuaranteeI_GetById_record.A_Amount);
          payable(PaymentGuaranteeI_GetById_record.A_pbaWallet).transfer(msg.value);
    ...
    PaymentGuaranteeI_Data.A_Status = 'Paid';
