...
contract trigger is owned {
  ...
  function invoke(IPaymentGuaranteeI.Data memory PaymentGuaranteeI_Data) public  returns(bool){
    ...
    PaymentGuaranteeI_Data.A_Added = block.timestamp * 1000;
    PaymentGuaranteeI_Data.A_Requestor = 'Main contractor';
    PaymentGuaranteeI_Data.A_FinanceProvider = 'Guarantor XYZ';
    PaymentGuaranteeI_Data.A_Contract = '/G.pdf';
    PaymentGuaranteeI_Data.A_Revision = 0;
    PaymentGuaranteeI_Data.A_Status = 'Submitted';
    PaymentGuaranteeI_Data.A_LastUpdate = block.timestamp * 1000;

    //Execute Action
    require(PaymentGuaranteeI.Insert(PaymentGuaranteeI_Data));
