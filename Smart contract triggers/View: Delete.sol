...
contract trigger is owned {
  ...
  function invoke(address _recordId) public  returns(bool){
    ...
    uint256 ViewII_GetById_index;
    IViewII.Data memory ViewII_GetById_record;
    IScheduleIII.Data memory ViewII_GetById_R_ScheduleIII_Data;
    (ViewII_GetById_index,ViewII_GetById_record,ViewII_GetById_R_ScheduleIII_Data) = ViewII.GetById(_recordId);
    ...
    //Execute Action
    require(ViewII.Delete(_recordId));
