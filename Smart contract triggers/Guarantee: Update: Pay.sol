...
contract trigger is owned {
  ...
  function invoke(address _recordId,IGteeII.Data memory GteeII_Data) public payable returns(bool){
    ...
    require(msg.value == GteeII_GetById_record.A_Guarantee);
          payable(GteeII_GetById_record.A_PBA).transfer(msg.value);
    ...
    GteeII_Data.A_Status = 'Paid';
    GteeII_Data.A_Contract = GteeII_GetById_record.A_Contract;
    GteeII_Data.A_Approved = GteeII_GetById_record.A_Approved;
